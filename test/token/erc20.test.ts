...
describe("ERC20 token wrapper", function () {
    ...
    describe("read only functions", function () {
        ...
        beforeEach(async function () {
            ...
            wrapper = await ERC20.fromAddressAndProvider(await token.getAddress(), ethers.provider as any);
    ...
    describe("transfer functions", function () {
        ...
        it("should approve andtransfer from another account", async function () {
            ...
            await wrapper
                .withSigner(await alice.getAddress())
                .transferFrom(await owner.getAddress(), await bob.getAddress(), amount);
